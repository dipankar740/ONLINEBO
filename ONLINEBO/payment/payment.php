...
$(document).ready(function () {
			...
			//alert(payamount);
			paymentRequest = {amount: '<?php echo $_POST['amount'] ?>', invoice: '<?php echo $_POST['rcode'] ?>' };
			//console.log(paymentRequest.amount, paymentRequest.invoice);
			$('#bKash_button').removeAttr('disabled');
			
			
			//window.location.href = "../client/PaymentStatus";
			
			jQuery(function(){
			   jQuery('#bKash_button').click();
			});
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data && data.paymentID != null) {
								...
								$.post("../client/PaymentStatus",
								{
								  tag: "success",
								  tracking_no: paymentRequest.invoice,
								...
								function(data,status){
								  ...
								  if(status=="success")
								  {
									  window.location.href = "https://bo.royalcapitalbd.com/Client/PaymentStatus?tag=success";
								  ...
								  {
									 window.location.href = "https://bo.royalcapitalbd.com/Client/PaymentStatus?tag=success&payment_id="; 
								  }
								});
